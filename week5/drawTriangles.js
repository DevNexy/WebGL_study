...
window.onload = function init() {
    ...
    document.getElementById("triangleColor").onclick = function(event){
        switch(event.target.value){
            case "red":
                ...
                break;
            case "green":
                // gl.uniform1f(fColor, 0.0,1.0,0.0,1.0);
                currentColor = vec4(0.0,1.0,0.0,1.0);
                break;
            case "blue":
                // gl.uniform1f(fColor, 0.0,0.0,1.0,1.0);
                currentColor = vec4(0.0,0.0,1.0,1.0);
                break;
            case "yellow":
                // gl.uniform1f(fColor, 1.0,1.0,0.0,1.0);
                currentColor = vec4(1.0,1.0,0.0,1.0);
                break;
            case "cyan":
                // gl.uniform1f(fColor, 0.0,1.0,1.0,1.0);
                currentColor = vec4(0.0,1.0,1.0,1.0);
                break;
            case "magenta":
                // gl.uniform1f(fColor, 1.0,0.0,1.0,1.0);
                currentColor = vec4(1.0,0.0,1.0,1.0);
                break;
            case "gray":
                // gl.uniform1f(fColor, 0.5,0.5,0.5,1.0);
                currentColor = vec4(0.5,0.5,0.5,1.0);
                break;
            case "black":
                // gl.uniform1f(fColor, 0.0,0.0,0.0,1.0);
