...
window.onload = function init()
{
    ...
    var viewLength = 2.0; //늘릴수록 보이는 영역이 더 넓어져서 큐브가 작아보임
    ...
    document.getElementById("change").onclick = function () {
        if(document.getElementById("ortho").checked == true){
            ...
            projectionMatrix = perspective(90, aspectRatio, 0.1, 1000); //각도가 클수록 시야각이 넓어져서 큐브가 작아보임
